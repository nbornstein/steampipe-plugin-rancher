...
func tableRancherReplicaSet(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "rancher_replicaset",
		Description: "Rancher replica set ensures that a specified number of pod replicas are running at any given time.",
