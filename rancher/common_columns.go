...
func objectMetadataSecondaryColumns() []*plugin.Column {
	return []*plugin.Column{
		...
		// DEPRECATED Rancher will stop propagating this field in 1.20 release and the field is planned to be removed in 1.21 release.
		// {Name: "self_link", Type: proto.ColumnType_STRING, Description: "SelfLink is a URL representing this object."},

		// Per https://v1-18.docs.rancher.io/docs/reference/generated/rancher-api/v1.18/#objectmeta-v1-meta
...
// append the common rancher columns for non-namespaced resources onto the column list
