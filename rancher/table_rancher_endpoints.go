...
func tableRancherEndpoints(ctx context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "rancher_endpoint",
		Description: "Set of addresses and ports that comprise a service. More info: https://rancher.io/docs/concepts/services-networking/service/#services-without-selectors.",
